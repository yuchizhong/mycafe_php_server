...
while ($row = mysql_fetch_array($result)) {
	...
	if ($spt == "0")
		...
		$spt = "0";
	 */
	$arr = array("support"=>$spt, 'black'=>$row['useBlackFont'], "name"=>$row['storeName'], "ID"=>$row['storeID'], "address"=>$row['addr'], "image"=>$row['logoFile'],  "rating"=>'5', "avgPrice"=>'30', "tel"=>$row['tel'], "businessTime"=>$row['businessHour'], "desp"=>$row['description']);
